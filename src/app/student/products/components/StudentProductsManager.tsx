...
function UserCard({ user }: { user: UiUser }) {
  ...
  return (
    <div className="rounded-2xl border border-blue-100 bg-blue-50/40 overflow-hidden">
      {/* Header */}
      <div className="flex items-center gap-3 px-4 py-3 border-b border-blue-100 bg-blue-50/60">
        <div className="w-8 h-8 rounded-xl bg-blue-600 flex items-center justify-center text-white font-black text-sm flex-shrink-0">
          {initials}
        </div>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 p-5 text-white">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
              <div className="min-w-0">
                ...
                {product.category !== "—" && (
                  <p className="text-blue-200 mt-1 text-[12px] font-semibold flex items-center gap-1.5">
            ...
            <div className="rounded-2xl border border-gray-100 bg-gray-50/60 px-4 py-3">
              ...
              <div className="flex flex-wrap gap-2">
                {product.countryCodes.map((c) => (
                  ...
                  >
                    <Globe className="w-3 h-3 text-blue-400" /> {c}
                  </span>
                ))}
              </div>
            </div>
        ...
        <div className="flex items-start gap-3 min-w-0 flex-1">
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-2 flex-wrap mt-1">
              ...
              {p.category !== "—" && (
                <span className="text-[11px] text-blue-700 bg-blue-50 border border-blue-100 px-2 py-0.5 rounded-lg font-bold">
                  {p.category}
                </span>
              )}
            </div>
        ...
        <div className="w-full max-w-full mx-auto">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
            ...
            <button
              ...
              className="inline-flex items-center gap-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-3 px-6 rounded-2xl transition-all shadow-lg shadow-blue-200 hover:shadow-xl hover:shadow-blue-300 hover:-translate-y-0.5 active:translate-y-0 whitespace-nowrap self-start lg:self-auto"
            >
          ...
          <div className="px-4 sm:px-5 py-4 border-b border-gray-100 bg-gray-50/40">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                <div className="flex items-center gap-2 rounded-2xl border border-gray-200 bg-white px-4 py-2.5 w-full sm:w-72 lg:w-80 shadow-sm focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-100 transition-all">
                ...
                <button
                  onClick={() => refetch?.()}
                  className="h-[42px] w-full sm:w-[42px] rounded-2xl border border-gray-200 bg-white flex items-center justify-center gap-2 text-gray-500 hover:bg-gray-50 hover:text-blue-600 transition-colors shadow-sm text-[12px] font-bold"
                  title="Refresh"
                >
                  <RefreshCw
              ...
              <div className="flex items-center justify-between sm:justify-end gap-2">
                ...
                <div className="px-3 py-2 rounded-xl bg-blue-600 text-white text-[11px] font-black shadow-sm min-w-[64px] text-center">
                  {page} / {totalPages}
                </div>
                <button
          ...
          {isFetching ? (
            ...
            <div className="flex items-center justify-center py-20">
              <div className="inline-flex flex-col items-center gap-3 text-gray-500">
                ...
                <button
                  onClick={() => setCreate(true)}
                  className="mt-1 inline-flex items-center gap-1.5 text-[11px] font-bold text-blue-600 bg-blue-50 border border-blue-100 px-3 py-1.5 rounded-lg hover:bg-blue-100"
                >
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {items.map((p) => (
                      ...
                      >
                        ...
                        <td className="px-5 py-4">
                          {p.category !== "—" ? (
                            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-blue-50 border border-blue-100 text-[11px] font-bold text-blue-700 whitespace-nowrap">
                        ...
                        <td className="px-5 py-4">
                          <div className="flex items-center gap-2 opacity-70 group-hover:opacity-100 transition-opacity">
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 px-3 h-8 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 text-gray-600 hover:text-blue-600 text-[11px] font-bold transition-colors shadow-sm whitespace-nowrap"
                            >
              ...
              <div className="flex items-center gap-1.5">
                {Array.from(
                  ...
                  <button
                    key={n}
                    onClick={() => setPage(n)}
                    className={`w-7 h-7 rounded-lg text-[11px] font-bold transition-colors ${n === page ? "bg-blue-600 text-white" : "bg-white border border-gray-200 text-gray-600 hover:bg-gray-50"}`}
                  >
                    {n}
                  </button>
                ))}
